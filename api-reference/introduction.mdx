...
<CardGroup cols={2}>
  <Card title="Media Management" icon="images" href="/api-reference/image/upload-an-image">
    Upload, list, and delete images, videos, and audio files. Manage your game's assets with ease.
  </Card>
  <Card title="Structured Logging" icon="terminal" href="/api-reference/logs/submit-logs-1">
    Submit logs from your game servers to a centralized, searchable dashboard.
  </Card>
  <Card title="Presigned URLs" icon="link" href="/guides/uploading-files/presigned-urls">
    Generate secure, temporary URLs for direct client-side uploads to our CDN.
  </Card>
  <Card title="SDK Integration" icon="bolt" href="/fivemanage/guides/logs/getting-started">
