...
If you wish to upload an image to the Image API, you can do so by sending a POST request to the https://api.fivemanage.com/api/v2/image endpoint.
...
const url = 'https://fmapi.net/api/v2/image';
...
const options = {
  method: 'DELETE',
  url: 'http://fmapi.net/api/image/delete/0987654321',
  headers: {
